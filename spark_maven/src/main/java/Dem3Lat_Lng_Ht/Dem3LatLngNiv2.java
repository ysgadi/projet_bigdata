...
import GridSingleton.GridTreeMap3;
import scala.Function2;
import scala.Tuple2;

public class Dem3LatLngNiv2 {
	private final static String tableName = "heightPointDataDG2";
	...
	public static void main(String[] args) throws Exception {
		...
		SparkConf conff = new SparkConf().setAppName("Niveau2Dem3LatLng");
		JavaSparkContext context = new JavaSparkContext(conff);
		String inputPath = args[0];
		GridTreeMap3 gridsInstance = GridTreeMap3.getInstance();
