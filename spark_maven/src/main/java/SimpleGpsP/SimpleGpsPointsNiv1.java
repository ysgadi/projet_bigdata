...
import GridSingleton.GridTreeMap2;
import scala.Tuple2;
import scala.Tuple3;

public class SimpleGpsPointsNiv1 {
	private final static String tableName = "SgpsPointsDG1";
	...
	public static void main(String[] args) throws Exception {
		...
		SparkConf conff = new SparkConf().setAppName("OpenStreetMapNiv1");
		JavaSparkContext context = new JavaSparkContext(conff);
		String inputPath = args[0];
		GridTreeMap2 gridsInstance = GridTreeMap2.getInstance();
